  ...
  id  bigserial not null,
   ...
   first_name varchar(255) not null,
    last_name varchar(255) not null,
     ...
     primary key (id));
 create table department (id  bigserial not null, name varchar(255) not null, company_id int8, primary key (id));
 create table emp_role_dep (id int8 not null, department_id int8, emp_id int8, role_id int8, primary key (id));

 create table role (id  bigserial not null, name varchar(255) not null, salary varchar(255) not null, primary key (id));
